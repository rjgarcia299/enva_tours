...
public class MainController {
	 ...
	 * }
	 * 
	 * @RequestMapping("/edit/task/{id}") public String
	 * edit(@Valid @ModelAttribute("task")Task task, BindingResult
	 * result, @PathVariable("id")Long id, Model model) { model.addAttribute("task",
